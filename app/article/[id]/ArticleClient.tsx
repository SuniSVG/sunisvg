...
import { 
    ArrowLeft, Folder, User, Calendar, Hash, Star, FileText, Tag, Download, 
    ArrowRight, Lock, MessageCircle, Clock, AlertCircle, BookOpen, Maximize, 
    Eye, DownloadCloud, ChevronRight, Share2, ExternalLink, CheckCircle2 
} from 'lucide-react';
...
// Helper tạo slug cho URL chuẩn SEO
...
export default function ArticleClient({ actualId }: { actualId: string }) {
    const id = actualId;
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            ...
            <nav className="flex items-center gap-2 text-sm text-gray-500 mb-4 overflow-x-auto whitespace-nowrap scrollbar-hide">
                ...
                <ChevronRight className="w-4 h-4 shrink-0" />
                <Link href={`/topics/${slugify(article.Category)}`} className="text-gray-900 font-medium truncate max-w-[200px] md:max-w-md hover:text-blue-600 transition-colors">
                    {article.Category}
                </Link>
            </nav>
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                    <div className="space-y-4 flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            <Link href={`/topics/${slugify(article.Category)}`} className="inline-flex items-center gap-1.5 px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-xs font-bold border border-blue-100 hover:bg-blue-100 transition-colors">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-4">
                    ...
                    <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm">
                        ...
                        <Link 
                            href="/articles"
                            className="w-full mt-4 py-3 text-xs font-black text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-xl transition-all flex items-center justify-center gap-2"
                        >
                            Xem thêm thư viện
